...
private:
    ...
    bool cal_lookahead_using_heading_thres_;

    double heading_thres_;
...
public:
    ...
    void setLocalGoalPose(geometry_msgs::PoseStamped local_goal);
    ...
    double calLookaheadDistanceUsingHeading();
    geometry_msgs::PoseStamped calLookaheadPoint(int nearest_index, double & lookahead_distance, 
                                            nav_msgs::Path path, int &output_index);
